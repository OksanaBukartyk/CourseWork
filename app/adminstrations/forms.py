...
class ProductAdminView(ModelView):
    ...
    column_list = ['name', 'description', 'timestamp', 'color', 'price','count', 'category'] #cтовпці
    #column_exclude_list = ('timestamp',)  #стовпці крім
    column_searchable_list = ('id', 'name', 'description','color', 'price','count', 'category')  #пошук по
    column_sortable_list = ('price', 'timestamp')   #сортування
    column_filters = ('color', 'timestamp')    #фільтр
